...
def load_dataset(dataset_dir, batch_size, valid_batch_size= None, test_batch_size=None, graph_embedding=None, incident=None):
    data = {}
    ...
    if incident == True:
        for category in ['train', 'val', 'test']:
            incident_data = np.load(os.path.join(dataset_dir, "incident_"+category + '.npz'))
